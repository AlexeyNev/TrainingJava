...
/**
 * Как вы уже знаете. Есть стримы примитивов IntStream, LongStream, DoubleStream. Обратите внимание, что это всё примитивы чисел,
 * а к числам применимы арифметические операции, поэтому в этих стримах есть терминальные операции min(), max(), sum(), average().
