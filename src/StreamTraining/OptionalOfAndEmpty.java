 ...
 * Во избежании подобных ситуаций, разработчики JDK решили добавить класс Optional.
 * Это класс обертка над значением.
 ...
 * а не Optional, но например, при добавлении если у вас есть Optional, заставит вас задуматься о проверке, прежде чем добавить значение.
 *
