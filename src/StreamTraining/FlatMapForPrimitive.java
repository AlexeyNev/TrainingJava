...
/**
 * Если нам нужно обходить структуры, которые имеют вложенные структуры (типа список списков, матрицы и тд), мы используем вложенные циклы.
 * Для стримов мы можем использовать методы, которые начинаются с префикса flat, например, flatMap(), flatMapToInt().
